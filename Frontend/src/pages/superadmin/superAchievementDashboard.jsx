          ...
          <div className="flex flex-col justify-between md:flex-row gap-4 mb-8">
            <div className="flex flex-1 max-w-md relative">
              ...
              <input
                type="text"
                placeholder="Search"
                className="pl-10 pr-4 h-10 rounded-l-md w-full border border-gray-300 focus:outline-none"
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
              />
              <button
                className="h-10 bg-yellow-400 hover:bg-yellow-500 text-black rounded-r-md px-4"
              >
                Search
              </button>
            </div>
                  ...
                  currentAchievements.map((achievement) => (
                    ...
                    >
                      <div className="w-20 h-20 rounded-full overflow-hidden mb-4 relative z-10">
                        <img
                          src={achievement.photo ? `data:image/jpeg;base64,${achievement.photo}` : "/placeholder.svg"}
