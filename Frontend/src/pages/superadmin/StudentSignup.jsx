...
//       if (response.ok) {
//         toast.success("Signup successful! Confirmation email sent.");
//         navigate("/manage-student"); // Redirect to student home page
//       } else {
...
//       {/* Form Container */}
//       <div className="w-3/4 min-h-3/4 max-h-[90%] bg-white shadow-lg rounded-lg flex items-stretch p-2">
...
//             className="w-3/4 flex flex-col pt-4 items-center"
//           >
