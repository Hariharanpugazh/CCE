...
//     // If we have 2 to 4 items, duplicate them to create a continuous effect
//     if (items.length < 5) {
//       const multiplier = Math.ceil(5 / items.length);
//       items = Array(multiplier).fill(items).flat().slice(0, 5);
//     }

//     // Duplicate the array to create a seamless loop, but limit to a maximum of 15 items
//     return [...items, ...items, ...items].slice(0, 15);
//   }, [achievements, carouselFilter]);

//   // Continuous carousel animation
//   useEffect(() => {
//     if (recentAchievements.length <= 1 || !isInView) return;

//     const startAnimation = async () => {
//       await carouselControls.start({
//         x: isCarouselPaused ? null : "-100%",
//         transition: {
//           duration: 15,
//           ease: "linear",
...
//     };
//   }, [recentAchievements.length, carouselControls, isCarouselPaused, isInView]);
...
//       {/* Featured Achievements Carousel - Enhanced with Continuous Animation */}
//       <div
//         ref={carouselInView}
...
//                 <button
//                   key={filter}
//                   onClick={() => setCarouselFilter(filter === carouselFilter ? "" : filter)}
...
//                     className="flex-shrink-0 w-[220px] md:w-[250px] px-2"
