...
//   return (
//     <div className="relative flex flex-col items-center justify-center min-h-screen from-gray-800 to-gray-900 text-black">
//       {/* Background Image */}
...
//       <motion.h1
//         className="text-5xl font-extrabold mb-6 text-center relative z-10"
...
//       <motion.p
//         className="text-lg text-center max-w-3xl mb-12 text-gray-500 relative z-10"
//         initial={{ opacity: 0 }}
//         animate={{ opacity: 1 }}
...
//       <motion.div
//         className="absolute bottom-8 text-gray-400 text-sm z-10"
//         initial={{ opacity: 0 }}
//         animate={{ opacity: 1 }}
