...
const Footer = () => {
  const categories = {
    Home: ["Opportunities", "Study Material", "Achievements"],
    Profile: ["My Profile", "Applied Jobs", "Saved Jobs"],
        ...
        <div className="flex justify-center md:hidden mb-4">
          <div className="text-center">
            <div className="flex items-center justify-center mb-2">
              <img
                src={SnsIcon} // Replace with the actual path to your SNS icon image
                alt="SNS Icon"
                className="w-10 h-7 md:w-8 md:h-8" // Adjust the size as needed
              />
            </div>
            ...
            <p className="text-xs">
              &copy; {new Date().getFullYear()} SNS Institutions. All Rights
              Reserved
            </p>
          </div>
        </div>
